...
--keelab ainult update triggeri
DISABLE TRIGGER trg_update
ON Tootajad;
...
--Kontroll kas triggerid tõõtavad
INSERT INTO Tootajad (nimi, amet, palk)
VALUES ('Kati', 'Admin', 1500);
UPDATE Tootajad
SET palk = 2500
WHERE id = 1;
...
CREATE USER sekretarSten
FOR LOGIN sekretarSten;
